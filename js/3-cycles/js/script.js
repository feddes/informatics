...
Выведите первые три товара в консоль под заголовком Принять в первую очередь. Не забудьте, что splice возвращает массив.
...
Оставшиеся товары выведите в консоль под заголовком Остальные товары. Решите задачу, максимально используя возможности ES2015.
*/